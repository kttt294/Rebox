...
export function SellerDisputes() {
  ...
  async function evidence(caseId: string, file?: File) {
    ...
    setNotice("Đã lưu thông tin bằng chứng mô phỏng; người mua và quản trị viên chỉ đọc đúng phiên bản đã ghi.");
  }
