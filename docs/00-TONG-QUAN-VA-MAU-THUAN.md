...
| M7  | **Thời gian hoàn tiền tự động** | "trong vòng**10 giây**"                                                             | A10 còn chặn payout thật; refund tranh chấp vẫn thủ công/async                                    | Bỏ cam kết 10 giây. Refund hủy đơn do timeout/pickup failure có thể tự tạo sau payment guard nhưng chỉ payout thật khi A10 đóng; tranh chấp GĐ1 vẫn do người xử lý.                                                                                                                                                 |
...
Auto-refund do **AI phân xử** và đặc biệt **auto-reject** ("AI TỪ CHỐI" trong UI admin) là quyết định tự động ảnh hưởng trực tiếp quyền lợi cá nhân. Đây là target GĐ3 và phải qua đánh giá theo Luật 91/2025/QH15, Nghị định 356/2025/NĐ-CP cùng legal gate hiện hành. Quy tắc hủy + refund tất định khi seller quá hạn xác nhận hoặc không bàn giao là flow riêng, vẫn phải qua payment guard và A10.
